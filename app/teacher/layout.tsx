...
export default function TeacherLayout({
  ...
  useEffect(() => {
    if (status === 'unauthenticated') {
      router.push('/login');
    } else if (session?.user && (session.user as any).role !== 'instructor') {
      router.push('/');
    }
            ...
            <div className="flex items-center gap-3">
              ...
              {sidebarOpen && (
                ...
                >
                  ...
                  <p className="text-cyan-400 text-xs truncate">Professeur</p>
                </motion.div>
              )}
            </div>
          </div>
              ...
              <div className="p-4 border-b border-cyan-500/30">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-cyan-400 text-xs">Professeur</p>
                  </div>
                </div>
              </div>
